...
class Api {
   ...
   * @returns {Promise<ClientListResult[]>} DBFluteクライアントのリスト (NotNull)
   */
   ...
   * @returns {Promise<EngineLatestResult>} 最新のDBFluteエンジンバージョン (NotNull)
   */
   ...
   * @returns {string[]} DBFluteエンジンバージョンの一覧 (NotNull)
   */
