...
/**
 * The bean class as param for remote API of POST /welcome/create.
 * @author FreeGen
 */
type WelcomeCreateBody = {
  /** (Required) */
  client: WelcomeCreateBody_ClientPart
 ...
 * @author FreeGen
 */
type WelcomeCreateBody_ClientPart = {
  ...
  /** (Required) */
  mainSchemaSettings: WelcomeCreateBody_DatabaseSettingsPart

  /** DBFluteクライアント作成時のDBFluteエンジンのバージョン、基本的に最新 e.g. "1 (Required) */
  dbfluteVersion: string

  /** (NullAllowed) */
  jdbcDriver?: WelcomeCreateBody_JdbcDriverPart
}
 ...
 * @author FreeGen
 */
type WelcomeCreateBody_DatabaseSettingsPart = {
 ...
 * @author FreeGen
 */
type WelcomeCreateBody_JdbcDriverPart = {
