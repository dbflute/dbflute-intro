...
import './client/document.tag'
import './client/schema-sync-check.tag'
import './client/replace-schema.tag'
import './client/alter-check.tag'
import './client/schema-policy-check.tag'
