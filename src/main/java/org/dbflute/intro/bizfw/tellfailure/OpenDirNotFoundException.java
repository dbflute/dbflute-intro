 ...
 * @author prprmurakami
 */
public class OpenDirNotFoundException extends IntroApplicationException {

    private static final long serialVersionUID = 1L;

    public OpenDirNotFoundException(String debugMsg, String dirPath) {
        super(debugMsg, prepareMessages(dirPath));
    }
