...
public class IntroMessages extends IntroLabels {
    ...
    /** The key of the message: Cannot delete the DBFlute Client for some reason: {0} */
    public static final String ERRORS_APP_CLIENT_CANNOT_DELETE = "{errors.app.client.cannotDelete}";
    ...
    /**
     * Add the created action message for the key 'errors.app.client.cannotDelete' with parameters.
     * <pre>
     * message: Cannot delete the DBFlute Client for some reason: {0}
     * </pre>
     * @param property The property name for the message. (NotNull)
     * @param arg0 The parameter arg0 for message. (NotNull)
     * @return this. (NotNull)
     */
    public IntroMessages addErrorsAppClientCannotDelete(String property, String arg0) {
        assertPropertyNotNull(property);
        add(property, new UserMessage(ERRORS_APP_CLIENT_CANNOT_DELETE, arg0));
        return this;
    }
