 ...
 * @author cabos
 */
public class PlaysqlMigrationCheckedZipRetrun {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public PlaysqlMigrationCheckedZipRetrun(String fileName, List<PlaysqlMigrationAlterSqlReturn> checkedSqlList) {
