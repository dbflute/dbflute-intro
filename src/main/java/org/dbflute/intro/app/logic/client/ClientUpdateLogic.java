...
public class ClientUpdateLogic {
    ...
    public void createClient(ClientModel clientParam) {
        doCreateClient(clientParam);
    }

    private void doCreateClient(ClientModel clientModel) {
        ...
        readyClientForCreate(clientModel, clientProject, clientDir);
        try {
    ...
    private void readyClientForCreate(ClientModel clientModel, String clientProject, File clientDir) {
        if (clientDir.exists()) { // no way, already exists so update
    ...
    private void doUpdateClient(ClientModel clientModel) {
        ...
        readyClientForUpdate(clientModel, clientProject, clientDir);
    ...
    private void readyClientForUpdate(ClientModel clientModel, String clientProject, File clientDir) {
        if (!clientDir.exists()) { // no way
